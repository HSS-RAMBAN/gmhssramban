...
import { getSchoolSettings } from '@/lib/queries';
  ...
  return (
    <div>
        ...
        <div className="container-page grid gap-12 lg:grid-cols-12 lg:items-center">
          <Reveal className="lg:col-span-7">
            ...
            <div className="prose-school mt-6">
              <p>{s?.school_description || s?.about_summary || 'The school provides education for students in Classes 9–12. At the higher secondary level (Classes 11–12), students can choose between Science and Arts streams.'}</p>
      ...
      <section className="bg-ink-50 py-20 sm:py-28">
        <div className="container-page">
          <SectionHeader eyebrow="Institutional identity" title="A clear academic journey" description="The school offers secondary education (Classes 9–10) followed by two higher secondary streams (Classes 11–12)." align="center" />
        ...
        <div className="container-page grid gap-8 lg:grid-cols-2">
          ...
          <Reveal delay={120}>
            <div className="card h-full p-8">
              ...
              <p className="mt-5 leading-relaxed text-ink-500">
                To deliver secondary and higher secondary education, with Science and Arts streams at the higher secondary level (Classes 11–12), supporting students as they grow academically and personally.
              </p>
      ...
      <section className="py-20 sm:py-28">
        <div className="container-page">
          <SectionHeader eyebrow="Our people" title="Staff Directory" description="Meet the educators and staff who guide our students." align="center" />
          <div className="mt-12"><PublicStaffDirectory /></div>
        </div>
      </section>
      ...
      <section className="bg-ink-50 py-20 sm:py-28">
        <div className="container-page">
          <SectionHeader eyebrow="Our campus" title="Infrastructure & Facilities" description="The facilities available at the school." align="center" />
          <div className="mt-12"><PublicInfrastructure /></div>
        </div>
      </section>
